...
CXXFLAGS += -std=c++11 -Wall -g -ggdb -I/usr/include/python2.7
...
all: test_x86 $(PROGS) afl-as test_build all_done clustering
...
afl-fuzz: afl-fuzz.c $(COMM_HDR) clustering hashmap | test_x86
	$(CC) $(CFLAGS) -c $@.c -o $@.o $(LDFLAGS)
	$(CXX) $(CFALGS) $(CXXFLAGS) $@.o clustering.o hashmap.o -o $@ $(LDFLAGS)
